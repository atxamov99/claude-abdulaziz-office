...
/** Common catalog type derived from en's structure with leaves widened to string (other languages must satisfy this). */
...
const CATALOGS: Record<Locale, Messages> = { en, ru, uz };
 ...
 * Falls back to en if missing in that locale, and returns the key string if missing there too.
 */
...
const INTL_TAGS: Record<Locale, string> = { en: "en-US", ru: "ru-RU", uz: "uz-UZ" };

/** BCP-47 tag for Intl.NumberFormat/toLocaleString, matching the given display locale. */
